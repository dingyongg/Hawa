...
- (void)addCircleWithColor:(UIColor *)color{
    ...
    bgLayer.strokeColor = [UIColor colorWithRed:212 green:212 blue:212 alpha:1.0].CGColor;
    ...
    bgLayer2.strokeColor = [UIColor colorWithRed:212 green:212 blue:212 alpha:1.0].CGColor;
    ...
    [leftGradientLayer setColors:[NSArray arrayWithObjects:(id)[UIColor colorWithRed:255 green:255 blue:212 alpha:1.0].CGColor, (id) [UIColor colorWithRed:255 green:255/2.0 blue:0 alpha:1.0].CGColor, nil]];
    ...
    [rightGradientLayer setColors:[NSArray arrayWithObjects:(id)[UIColor colorWithRed:255 green:255 blue:0 alpha:1.0].CGColor,(id) [UIColor colorWithRed:255 green:0 blue:0 alpha:1.0].CGColor, nil]];
